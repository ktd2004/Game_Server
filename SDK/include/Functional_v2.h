...
class functional_v2 : public functional_base
{
...
class mfunctional_v2 : public functional_base
{
public:
	typedef R (T::*FuncPtr)(A,B);
	implement_mfunctional(v2);
public:
	R operator() (A a1, B b1)
	{
		return (m_Inst->*m_Func)(a1, b1);
	}
};