...
class functional_v5 : public functional_base
{
	...
	public:
		...
		{
			return ((*m_pO).*m_F)(t1, t2, t3, t4, t5);
		}
	private:
		O m_pO;
		F m_F;
...
public:
	implement_functional(v5);

public:
	R operator()(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
	{
		return (*m_impl)(t1, t2, t3, t4, t5);
	}
};
...
class mfunctional_v5 : public functional_base
{
public:
	typedef R (T::*FuncPtr)(A,B,C,D,E);
	implement_mfunctional(v5);
public:
	R operator() (A a1, B b1, C c1, D d1, E e1)
	{
		return (m_Inst->*m_Func)(a1, b1, c1, d1, e1);
	}
};