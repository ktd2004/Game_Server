...
class functional_v3 : public functional_base
{
	...
	public:
		...
		virtual R operator ()(T1 t1, T2 t2, T3 t3)
		{
			return ((*m_pO).*m_F)(t1, t2, t3);
		}
	private:
		O m_pO;
		F m_F;
...
public:
	implement_functional(v3);

public:
	R operator()(T1 t1, T2 t2, T3 t3)
	{ return (*m_impl)(t1, t2, t3); }
};
...
class mfunctional_v3 : public functional_base
{
public:
	typedef R (T::*FuncPtr)(A,B,C);
	implement_mfunctional(v3);
public:
	R operator() (A a1, B b1, C c1)
	{
		return (m_Inst->*m_Func)(a1, b1, c1);
	}
};