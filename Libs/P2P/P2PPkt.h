...
//< p2p packet header
class P2PNET_PACKET_BASE //: public listnode(P2PNET_PACKET_BASE)
{
public:
	SOCKADDR_IN			Addr;		// send address
	unsigned int		iLen;		// packet length
	unsigned int		iPackID;	// packet id
	...
	virtual ~P2PNET_PACKET_BASE() {}
};

//typedef util::list<P2PNET_PACKET_BASE>	P2PNET_PACKET_LIST;
typedef Buffer::QType	P2PNET_PACKET_LIST;
...
//< sync packet
class P2P_SYNC : public P2PNET_PACKET_BASE
{
public:
...
//< sync ack packet
class P2P_SYNC_ACK : public P2PNET_PACKET_BASE
{
public:
	...
	virtual ~P2P_SYNC_ACK() {}
};

//< keep connection packet
class P2P_KEEP_CONNECTION : public P2PNET_PACKET_BASE
{
public:
	...
	virtual ~P2P_KEEP_CONNECTION() {}
};


//< reliable ack packet
class P2P_RELIABLE_ACK : public P2PNET_PACKET_BASE
{   
public:
	...
	virtual ~P2P_RELIABLE_ACK() {}
};


//< join packet
class P2P_JOIN : public P2PNET_PACKET_BASE
{
public:
	Network_IF			NIF;
...
//< join ack packet
class P2P_JOIN_ACK : public P2PNET_PACKET_BASE
{
public:
	P2P_JOIN_ACK(PKTSEQ iPktSeq, unsigned int iCellID, TNID iFromID, unsigned long iTransTick)
	{
	...
	virtual ~P2P_JOIN_ACK() {}
};


//< leave packet
class P2P_LEAVE : public P2PNET_PACKET_BASE
{
public:
	Network_IF	NIF;
...
//< leave ack packet
class P2P_LEAVE_ACK : public P2PNET_PACKET_BASE
{
public:
